...
const TradeDetailModal: React.FC<TradeDetailModalProps> = ({ trade, onClose, onAddNote, onCloseTrade }) => {
  ...
  return (
    <div className="fixed inset-0 bg-brand-light z-[100] animate-fade-in-up flex flex-col h-[100dvh]">
